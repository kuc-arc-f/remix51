...
import { TodoList } from "./form11/TodoList"
import { todoSchema } from "./form11/todo-validation";
import Head from '../components/Head';
import CrudIndex from "./form11/CrudIndex";
...
export default function Index() {
  ...
  <>
    ...
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-8">Form11</h1>
      <TodoList data={data} />
    </div>
  </>
  )
